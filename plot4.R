...
#plot 4
x2 <- dfs$datetime; y2 <- dfs$Global_active_power
...
legend("toprigh", legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col= c("black","red","blue"), lty = c(1,1,1), bty ="n")
plot(x2, dfs$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l")

#create png file
dev.copy(png, "plot4.png", width=720,height=480)
dev.off()